...
//> STATIC CONSTANTS
	...
	/** Location of <code>javax.comm.properties</code> file used to specify driver to use when using {@link #PACKAGE_JAVAXCOMM} */
	public static String javaxCommPropertiesPath = "javax.comm.properties";
